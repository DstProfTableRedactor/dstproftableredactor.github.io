...
<template>  
  <div class="text-wrapper">
    ...
    <article>
      Заголовок таблицы редактируется только из текстового поля, покраска клетки под "Наименование материала" ломает выравнивание (в ряду должна быть хотя бы одна непокрашенная клетка, чтобы после нее выравнивалось по центру). небагофича. 
